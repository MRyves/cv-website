  ...
  return (
    <Template title="WORK EXPERIENCE">
      <WorkItemList>
        ...
        >
          Following an eight-month sabbatical, I rejoined OpenConcept to lead the full-stack modernization of a legacy government management system. 
          In this role, I architect and implement end-to-end features, leveraging Lit.js and TypeScript for the frontend while ensuring deep integration and co-development with our Java/Quarkus-based backend. 
          My responsibilities span the entire development lifecycle, from Requirement and Feature Engineering with stakeholders to the implementation of scalable technical solutions. 
          By owning the vertical slice of the application, I ensure architectural consistency, high performance, and data integrity. I actively employ AI-assisted tools to streamline full-stack prototyping and maintain high code quality, delivering a robust, future-proof system for the public sector.
        </WorkItem>
